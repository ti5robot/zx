...
int main(int argc, char** argv)
{
    ...
    for(int i=0;i<IDNUM;i++) bais[i]=bais[i]/180*pi;
        initsock();
    ...
    move_to_joint(2);sleep(4);
    std::cout<<"rrr";

        show_value("TH.j: ",TH.pos);
/*
...
*/
	...
	//uint8_t canidlist2[10]={1,2,7},cmd2[10]={30,30,30};
	//uint8_t canidlist2[10]={1,2,3,4,5,6},cmd2[10]={30,30,30,30,30,30};
	uint8_t canidlist2[10]={1},cmd2[10]={30};
	uint32_t parameterlist2[10]={0};
        sendCommand(1,canidlist2,cmd2,parameterlist2);  
        }
