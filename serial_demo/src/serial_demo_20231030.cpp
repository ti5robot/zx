...
void Listener::callback(const moveit_msgs::DisplayTrajectory::ConstPtr &msg)
{
	...
	i=25;
        ...
        //{
            ...
            if (cn[0] < 0)
            {
                r1[0] = ori_position[0] - i * abs(int(cn[0] / round_i));
            }
            ...
            if (cn[1] < 0)
            {
                r2[0] = ori_position[1] - i * abs(int(cn[1] / round_i));
            }
            ...
            if (cn[2] < 0)
            {
                r3[0] = ori_position[2] - i * abs(int(cn[2] / round_i));
            }
            ...
            if (cn[3] < 0)
            {
                r4[0] = ori_position[3] - i * abs(int(cn[3] / round_i));
            }
            ...
            if (cn[4] < 0)
            {
                r5[0] = ori_position[4] - i * abs(int(cn[4] / round_i));
            }
            ...
            if (cn[5] < 0)
            {
                r6[0] = ori_position[5] - i * abs(int(cn[5] / round_i));
            }
            ...
            parameterlist2[0] = r1[0];
            parameterlist2[1] = -r2[0];
            parameterlist2[2] = -r3[0];
            parameterlist2[3] = r4[0];
            parameterlist2[4] = -r5[0];
            parameterlist2[5] = r6[0];
	...
	tmp0=1000;
	tmp1=-1000;
        uint32_t parameterlist2221[10] = {tmp0,tmp0,tmp0,tmp0,tmp0,tmp0};
        uint32_t parameterlist22221[10] = {tmp1,tmp1,tmp1,tmp1,tmp1,tmp1};
        //uint32_t parameterlist2221[10] = {tmp0,tmp0,tmp0,tmp0,tmp0,tmp0};
        //uint32_t parameterlist22221[10] = {tmp1,tmp1,tmp1,tmp1,tmp1,tmp1};
	...
	tmp0=1000;
	tmp1=-1000;
        uint32_t parameterlist22211[10] = {tmp0,tmp0};
        uint32_t parameterlist222211[10] = {tmp1,tmp1};
            //sendCanCommand(2, canidlist222, cmd222, parameterlist22211);

            //sendCanCommand(2, canidlist222, cmd2222, parameterlist222211);
        parameterlist2[10] = {0};
        for (int i = 25; i < 30; i++)
        {
