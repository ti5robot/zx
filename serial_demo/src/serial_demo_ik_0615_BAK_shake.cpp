...
void Listener::callback(const sensor_msgs::JointState::ConstPtr &msg) {
 ...
 for (int i = 1; i < 3-1; i++) {
		        usleep(30);
        ori_position[0]=next_position[0] ;
        ori_position[1]=next_position[1] ;
        ori_position[2]=next_position[2] ;
        ori_position[3]=next_position[3] ;
        ori_position[4]=next_position[4] ;
        ori_position[5]=next_position[5] ;




        next_position[0]=msg->position[0]/6.28*101*65536 ;
        next_position[1]=msg->position[1]/6.28*101*65536 ;
        next_position[2]=msg->position[2]/6.28*101*65536 ;
        next_position[3]=msg->position[3]/6.28*101*65536 ;
        next_position[4]=msg->position[4]/6.28*101*65536 ;
        next_position[5]=msg->position[5]/6.28*101*65536 ;
	...
	std::cout<<"cn1:"<<cn[1]<<"ori_position"<<ori_position[1]<<"next_position"<<next_position[1]<<std::endl;
	std::cout<<"cn2:"<<cn[2]<<"ori_position"<<ori_position[2]<<"next_position"<<next_position[2]<<std::endl;
	std::cout<<"cn3:"<<cn[3]<<"ori_position"<<ori_position[3]<<"next_position"<<next_position[3]<<std::endl;
	std::cout<<"cn4:"<<cn[4]<<"ori_position"<<ori_position[4]<<"next_position"<<next_position[4]<<std::endl;
	std::cout<<"cn5:"<<cn[5]<<"ori_position"<<ori_position[5]<<"next_position"<<next_position[5]<<std::endl;
	//std::cout<<ori_position[0]<<std::endl;
	//std::cout<<ori_position[1]<<std::endl;
//	std::cout<<ori_position[2]<<std::endl;
        int round_i;
    ...
    //std::cout<<"round_i"<<round_i<<std::endl;
		...
		//if (status==1&&i<round_i*0.7){i=i+10;}
                         ...
                         if (cn[0]<0)
                         {
		             std::cout<<ori_position[0]-i*abs(int(cn[0]/round_i))<<std::endl;
			     //std::cout<<r1[i];
...
int main(int argc, char** argv)
{
    ...
    ros::Rate loop_rate(500);
        ...
        ros::Subscriber client_sub = nh.subscribe("/ik_result", 1000, &Listener::callback, &listener);
